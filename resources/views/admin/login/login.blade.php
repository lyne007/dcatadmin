...
<style>
    .login_main {
        ...
        flex-direction: row;
        align-items: stretch;
        background: url({!! admin_setting('logobg') ? ('/storage/'.admin_setting('logobg')):'/static/img/bg-auth.jpg' !!}) center;
    ...
    <div class="col-md-3 col-sm-3 col-12 ">
        <div class="login-page">
            ...
            <div class="auth-brand text-center text-lg-left">
                <img src="{!! admin_setting('logo') ? ('/storage/'.admin_setting('logo')):'/static/img/logo.png' !!}" width="35"> &nbsp;{!! admin_setting('webname') !!}
            </div>
